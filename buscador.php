...
<form method="GET" class="filtro-anio">
    ...
    <button type="button" onclick="searchTable()">Filtrar</button>
        ...
        <tbody id="tableBody">
            ...
            <?php
                ...
                ?>
                    ...
                    <td class="fecha" style="text-align: center;"><?= htmlspecialchars($fila["FInicial"] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
                    <td class="fecha" style="text-align: center;"><?= htmlspecialchars($fila["FFinal"] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
