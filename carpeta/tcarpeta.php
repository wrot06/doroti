...
<body>
            ...
            <div class="card-body">
                ...
                <form action="finalizarcarpeta.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tituloCarpeta" name="tituloCarpeta" class="form-control" maxlength="56" rows="3" style="font-size: 1.4rem;" required></textarea>
                        <div class="text-right"><small id="contadorTitulo" class="text-muted">0 / 56</small></div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Voz
            iniciarVoz('tituloCarpeta', 'grabarBoton', 'contadorTitulo');
