...
// Si empieza con letra, capitalizar solo la primera
if ($tituloCarpeta !== '' && preg_match('/^\p{L}/u', $tituloCarpeta)) {
    $tituloCarpeta = mb_strtoupper(mb_substr($tituloCarpeta, 0, 1, "UTF-8")) 
                   . mb_substr($tituloCarpeta, 1, null, "UTF-8");
}
