...
<div class="etiquetas mb-1" style="font-size: 0.75rem;">
    ...
    <form id="capituloForm">
        ...
        <div class="form-row align-items-center mb-2"> <!-- Reduce el margen inferior -->
            ...
            <div class="col-auto">
                <input type="number" id="paginaFinal" class="form-control form-control" placeholder="Página de Finalización" value="<?= $ultimaPagina + 1 ?>" required> <!-- Añadido class 'form-control-sm' -->
            </div>
