document.addEventListener("DOMContentLoaded", function () {
    ...
    function actualizarRadios() {
        ...
        document.querySelectorAll('.form-check-label').forEach(function(label) {
            ...
            label.style.textTransform = ""; // restablecer transformación de texto
        });
        ...
        if (seleccionado) {
            ...
            if (label) {
                ...
                label.style.color = "#a4151cff";           // color
                label.style.textDecoration = "underline"; // subrayado
                label.style.fontWeight = "bold";         // negrita
                       // un poco más grande
                l
            }
        }
