...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($caja > 0 && $car2 > 0) {
        ...
        try {
            ...
            error_log("Error de base de datos: " . $e->getMessage()); // Registro del error en el log
            $_SESSION['mensaje'] = "Error inesperado. Por favor, inténtalo de nuevo."; // Mensaje más general para el usuario
            header("Location: ../agregarcarpeta.php");
            exit();
        } finally {
            if (isset($stmt)) {
